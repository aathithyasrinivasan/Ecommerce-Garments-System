...
import { buyComplete } from "../slice/buySlice";
...
function BuyPayment(){
    ...
    const {items:buyItems,shippingInfo}=useSelector(state=>state.buyState)
    ...
    return(
        <div className="home-panel">
             <Steps shipping confirm payment buypayment/>  
